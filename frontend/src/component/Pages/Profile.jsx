...
const handleSubmit= async(e)=>{
  ...
  try {
    ...
    const res=await fetch(`/backend/auth/update/${currentUser._id}`,{
      method: 'POST',
      headers: {
...
return (
  <div className='p-3 max-w-lg mx-auto bg-gradient-to-r from-blue-50 to-indigo-100'>
...
<input
      ...
      placeholder='Address'
      onChange={handleChange}
      defaultValue={currentUser.address || "XYZ"}
      id='address'
      className='border p-3 rounded-lg'
    />
<input
      ...
      onChange={handleChange}
      defaultValue={currentUser.phone || "000000"}
      id='phone'
      className='border p-3 rounded-lg'
    />
    <button
